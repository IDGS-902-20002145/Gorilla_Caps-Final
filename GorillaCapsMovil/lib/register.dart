                    ...
                    if (_passwordController.text !=
                      ...
                      try {
                        ...
                        final fecha = DateFormat('yyyy-MM-dd')
                            .format(DateTime(annio, mes, dia).toLocal());

                        final response = await widget.client.post(
                          Uri.parse(
                              'https://192.168.1.9:5000/api/Login/Registrar'),
                          headers: <String, String>{
                            'Content-Type': 'application/json; charset=UTF-8',
                          },
                          body: jsonEncode(<String, dynamic>{
                            // Use "dynamic" to handle various data types
                            'id': 0,
                            ...
                            'empleado':
                                false, // Assuming "roles" is an array, send it as an empty list
                          }),
                        );

                        if (response.statusCode == 201) {
                          //Si la respuesta es correcta, mostramos una alerta con el mensaje de bienvenida
                          _showAlert(context, "¡Bienvenido a GorillaCaps!",
