...
def load_data():
    ...
    ventas_producto_por_mes_df.to_sql('ventas_producto_por_mes', con=engine, if_exists='replace', index=False)
    top5_clientes_por_mes_df.to_sql('top5_clientes_por_mes', con=engine, if_exists='replace', index=False)
    utilidad_por_mes_df.to_sql('utilidad_por_mes', con=engine, if_exists='replace', index=False)
    compras_por_proveedor_df.to_sql('compras_por_proveedor', con=engine, if_exists='replace', index=False)
    ...
    os.remove('data/ventas_producto_por_mes.csv')
    os.remove('data/top5_clientes_por_mes.csv')
    os.remove('data/utilidad_por_mes.csv')
    os.remove('data/compras_por_proveedor.csv')
